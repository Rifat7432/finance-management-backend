...
router.get('/', partnerRequest_controller_1.PartnerRequestController.getPartnerRequests);
router.get('/:id', partnerRequest_controller_1.PartnerRequestController.getSinglePartnerRequest);
...
router.delete('/:id', partnerRequest_controller_1.PartnerRequestController.deletePartnerRequest);
