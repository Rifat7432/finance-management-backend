...
router.get('/:id', dateNight_controller_1.DateNightController.getSingleDateNight);
router.patch('/:id', (0, validateRequest_1.default)(dateNight_validation_1.DateNightValidation.updateDateNightZodSchema), dateNight_controller_1.DateNightController.updateDateNight);
router.delete('/:id', dateNight_controller_1.DateNightController.deleteDateNight);
